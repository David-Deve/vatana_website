    ...
    <div class="container">
      <div class="row mb-5 justify-content-between">
        ...
        <div class="col-lg-5">
          ...
          >
            <p>
              {{ $t("Project.decription4_1") }}
            </p>
            <p>
              {{ $t("Project.decription4_2") }}
            </p>
          </div>
        </div>
      </div>
...
import { ref } from "vue";
const images = ref([
  "assets/project4_pic/1.png",
  "assets/project4_pic/2.png",
  "assets/project4_pic/3.jpg",
  "assets/project4_pic/4.png",
  "assets/project4_pic/5.png",
  "assets/project4_pic/6.png",
]);
</script>
