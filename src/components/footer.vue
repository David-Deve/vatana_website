...
<div class="site-footer bg-light">
		<div class="container">
				...
				<div class="col-lg-4">
					...
					<div class="widget">
						...
						<ul class="social list-unstyled mb-5">
							<li><a href="#"><i class='bx bxl-facebook-square' style="font-size: 50px;"></i></a></li>
							<li><a href="#"><i class='bx bxl-twitter' style="font-size: 50px;" ></i></a></li>
							<li><a href="#"><i class='bx bxl-instagram-alt' style="font-size: 50px;" ></i></a></li>
							<li><a href="#"><i class='bx bxl-dribbble' style="font-size: 50px;" ></i></a></li>
			...
			<div class="row justify-content-center text-center copyright">
				<div class="col-md-8">
					<p class="small text-black-50">Copyright &copy. All Rights Reserved. Designed with love by <a href="https://untree.co">Untree.co</a></br>Distributed By <a href="https://themewagon.com/">Themewagon</a> <!-- License information: https://untree.co/license/ -->
					</p>
				</div>
			</div>
		</div>
